...
class ObservableAppState extends EventEmitter {
  ...
  jumbles = [
    ...
    new Jumble({ name: '🫏 Jumble', body: "The gregarious donkey, with its insatiable appetite, voraciously devoured an assortment of succulent, ambrosial fruits, including pomegranates, persimmons, and pineapples, savoring each delectable morsel with an almost anthropomorphic delight, while its prehensile lips meticulously navigated the labyrinthine intricacies of the fruit’s exocarp and mesocarp." })
  ]
